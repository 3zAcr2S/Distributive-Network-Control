...
volatile int duration1, duration2;
...
void setup()
{
  ...
  attachInterrupt(echoPin1, get_duration1, CHANGE);
  attachInterrupt(echoPin2, get_duration2, CHANGE);
...
void camMove1() {
  ...
  if (blocks)
  {
    panError = X_CENTER - pixy1.blocks[0].x;
    tiltError = pixy1.blocks[0].y - Y_CENTER;

    panLoop.update(panError);
    tiltLoop.update(tiltError);

    pixy1.setServos(panLoop.m_pos, tiltLoop.m_pos);
