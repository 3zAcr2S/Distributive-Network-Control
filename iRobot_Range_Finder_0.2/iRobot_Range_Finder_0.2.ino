...
void dataminingMust() {
  ...
  //  while ( !(abs(t_c1 - t_c2) < 10 && (t_c1)  && (t_c2)) )
  while ( (i_c1s1 == -1) || (i_c1s2 == -1) || (i_c2s1 == -1) || (i_c2s2 == -1) )
  {
    ...
    if (blocks1)
    {
      ...
      {
        t_c1 = millis();
        //        VectorCalc(pixy1.blocks[i_c1s1].x , pixy1.blocks[i_c1s1].y , pixy1.blocks[i_c1s2].x , pixy1.blocks[i_c1s2].y , 1);
//        camVecUpdate(1);
      }
    }
    ...
    if (blocks2)
    {
      ...
      if ((i_c2s1 != -1) && (i_c2s2 != -1))
      {
        t_c2 = millis();
//         camVecUpdate(2);
        //        VectorCalc(pixy2.blocks[i_c2s1].x , pixy2.blocks[i_c2s1].y , pixy2.blocks[i_c2s2].x , pixy2.blocks[i_c2s2].y , 1);
